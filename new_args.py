...
class_name_path = './data/pitta.names'  # The path of the class names.
...
class_num = 3#len(classes)
train_img_cnt = 10#len(open(train_file, 'r').readlines())
val_img_cnt = 10#len(open(val_file, 'r').readlines())
